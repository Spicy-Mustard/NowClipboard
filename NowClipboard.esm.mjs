...
var require_NowClipboard = __commonJS({
  "src/NowClipboard.js"(exports, module) {
    (function(root, factory) {
      ...
      function copyImage2(source, options) {
      ...
      function NowClipboard2(trigger, options) {
        if (!(this instanceof NowClipboard2)) {
          return new NowClipboard2(trigger, options);
        }
      ...
      NowClipboard2.prototype = Object.create(EventEmitter.prototype);
      NowClipboard2.prototype.constructor = NowClipboard2;
      NowClipboard2.prototype._checkDestroyed = function() {
        if (this._destroyed) {
          throw new Error("NowClipboard instance has been destroyed. Create a new instance.");
        }
      };
      NowClipboard2.prototype.resolveOptions = function(opts) {
      ...
      NowClipboard2.prototype.listenClick = function(trigger) {
        var self2 = this;
        this._listener = bindListener(trigger, "click", function(e) {
          self2.onClick(e);
        });
      };
      NowClipboard2.prototype.onClick = function(e) {
      ...
      var _originalOn = NowClipboard2.prototype.on;
      NowClipboard2.prototype.on = function() {
        this._checkDestroyed();
        return _originalOn.apply(this, arguments);
      };
      var _originalOnce = NowClipboard2.prototype.once;
      NowClipboard2.prototype.once = function() {
        this._checkDestroyed();
        return _originalOnce.apply(this, arguments);
      };
      var _originalOff = NowClipboard2.prototype.off;
      NowClipboard2.prototype.off = function() {
        this._checkDestroyed();
        return _originalOff.apply(this, arguments);
      };
      NowClipboard2.prototype.defaultAction = function(trigger) {
        return getAttr("action", trigger) || "copy";
      };
      NowClipboard2.prototype.defaultTarget = function(trigger) {
      ...
      NowClipboard2.prototype.defaultText = function(trigger) {
        return getAttr("text", trigger);
      };
      NowClipboard2.prototype.destroy = function() {
      ...
      NowClipboard2.read = function(options) {
        return readText(options);
      };
      NowClipboard2.readRich = function(options) {
        if (!_isBrowser) {
      ...
      NowClipboard2.checkSupport = function(actions) {
      ...
      NowClipboard2.queryPermission = function(name) {
      ...
      NowClipboard2.copyImage = function(source, options) {
        if (!_isBrowser) {
      ...
      NowClipboard2.copyBlob = function(blob, mimeType, options) {
        if (!_isBrowser) {
      ...
      NowClipboard2.copyRich = function(options) {
...
// src/NowClipboard.esm.js
var import_NowClipboard = __toESM(require_NowClipboard());
var NowClipboard_esm_default = import_NowClipboard.default;
var copy = import_NowClipboard.default.copy;
var cut = import_NowClipboard.default.cut;
var read = import_NowClipboard.default.read;
var readRich = import_NowClipboard.default.readRich;
